...
func Run() error {
	...
	r.GET("/api/community/knowledge-bases", proxyCommunityCharacterAPI)
	r.GET("/api/community/knowledge-bases/:id", proxyCommunityCharacterAPI)
	r.GET("/api/community/knowledge-bases/:id/content", proxyCommunityCharacterAPI)

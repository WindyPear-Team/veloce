...
func RegisterCommunityAdvancedChatUserRoutes(group *gin.RouterGroup) {
	...
	group.GET("/advanced-chat/embedding-models", api.listBuiltinEmbeddingModels)
	group.POST("/advanced-chat/embeddings", api.createBuiltinEmbeddings)
	group.POST("/advanced-chat/builtin-embeddings", api.createBuiltinEmbeddings)
